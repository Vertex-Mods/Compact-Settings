...
> [!NOTE]
> Pull Requests to this GitHub repository will not be merged. This project is maintained in another repository: [BibekBhusal0/zen-custom-js/compact-settings](https://github.com/BibekBhusal0/zen-custom-js/tree/main/compact-settings), please open pull requests there.
